...
class _PermissionScreenState extends State<PermissionScreen>
  ...
  Future<void> _checkAllPermissions() async {
    ...
    try {
      ...
      _isApiConfigured = await _secureStorage.hasPuterConfiguration();
  ...
  Future<bool> _checkAccessibilityPermission() async {
    try {
      ...
      if (hasPermission) {
        await platform
            .invokeMethod('saveAccessibilityConsent', {'granted': true});
      }
  ...
  Future<bool> _checkAudioPermission() async {
    try {
      const platform = MethodChannel('com.vibeagent.dude/agent');
      final hasPermission =
          await platform.invokeMethod('checkAudioPermissions');
              ...
              gradient: isPrimary
                  ...
                  : const LinearGradient(
                      colors: [
                        ...
                        Color(
                            0xFFE5E7EB), // Slightly darker at bottom for depth
                      ],
                      begin: Alignment.topCenter,
                      end: Alignment.bottomCenter,
                      stops: [0.0, 0.7, 1.0],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildPermissionListItem(
                        ...
                        description: 'Sign in to Puter for free AI models',
                      ...
                      _buildPermissionListItem(
                        ...
                        description:
                            'Allow voice commands and audio processing',
